...
import com.naveen.beans.PackingBean;
 ...
 * 
 * @author Naveen
 * This class is part of the new requirement, for getting packing 
 * the methods getOrderPlacedStudentsOfSchool is copied from StudentDAO, re written since the studentDAO class 
 * is not returning oid, here we need oid 
 */
...
public class PackingDAO {
	 ...
	 * used, becuase when user sees, first hold (Orange), Not Packed (Red), Packed(Green) 
	 */
	public List<PackingBean> getOrderPlacedStudentsOfSchool(int schId, String cls, String startDate, String endDate, String sex) {
		...
		GetConnection gc  = new GetConnection();
			...
			java.util.Collections.sort(packingList, 
					new Comparator<PackingBean>() {
	...
	public  List<String> getMeasurementsForOdid(int odid){
		...
		try {
			...
			// this condition is check because when displaying PackingReportDashBoad Graph you cannot display 
	...
	public static void main(String[] args) {
		...
		List<PackingBean> list = new PackingDAO().getOrderPlacedStudentsOfSchool(2, "NUR", "2017-01-01", "2018-01-10", "B");
